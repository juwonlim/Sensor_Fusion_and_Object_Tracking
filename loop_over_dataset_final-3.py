#프로젝트 지침 1단계, 범위 이미지 채널 시각화 (ID_S1_EX1)
...
#data_filename = 'training_segment-10072231702153043603_5725_000_5745_000_with_camera_labels.tfrecord' # Sequence 2 --> 최종프로젝트 1단계,2단계
...
#show_only_frames = [65, 100] # 최종프로젝트 2 단계                   
...
#results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results') #에러발생
...
#configs_det.use_labels_as_objects = True #  #프로젝트 지침 4단계,정밀도 및 재현율 계산 (ID_S4_EX3), 두번째 구동

## Uncomment this setting to restrict the y-range in the final project
# configs_det.lim_y = [-25, 25] 
configs_det.lim_y = [-25, 25] #최종프로젝트 3단계 , y-범위를 제한하고 표적의 좌우에 있는 다른 표적들을 제거
