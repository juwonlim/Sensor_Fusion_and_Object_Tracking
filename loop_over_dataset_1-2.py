...
#results_fullpath = '/home/workspace/results/darknet/results_sequence_1_darknet' #에러발생
results_fullpath = os.path.join('/home/workspace/results/darknet/results_sequence_2_darknet') #지침 1단계,ID S1 EX2에서 윗줄로 실행하면 에러가 나서 이렇게 바꿔봄
datafile = WaymoDataFileReader(data_fullpath)
datafile_iter = iter(datafile)  # initialize dataset iterator    
