...
def display_intensity_map_with_numbers(intensity_map):
        ...
        # 창에 이미지 표시
        plt.show() #matplotlib으로 출력처리

        # intensity map과 숫자화된 맵을 새 창에 표시
        #cv2.waitKey(0) #matploblib과 opencv의 창 충돌을 예방히기위해 주석처리
...
def bev_from_pcl(lidar_pcl, configs):
    ...
    # Step Additional by lim : intensity map numbering 표시
    # 숫자 맵 표시
    # Step Additional by lim : intensity map numbering 표시
    display_intensity_map_with_numbers(intensity_map) #여기서 위의 함수를 호출
